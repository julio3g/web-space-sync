  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            'group rounded-md border border-input px-3 py-2 text-sm bg-background ring-offset-background focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2',
            className,
          )}
        >
